...
/**
*
* @version $Id: get_final_confirmation.tpl.php 2285 2010-02-01 10:57:18Z soeren_nb $
* @package VirtueMart
...
if(!ps_checkout::noShipToNecessary()) {
	...
	$q2 = "SELECT * FROM #__{vm}_state WHERE country_id=".(int)$country_id." AND state_2_code='".$db->f("state")."'";
	$dbs->query($q2);
