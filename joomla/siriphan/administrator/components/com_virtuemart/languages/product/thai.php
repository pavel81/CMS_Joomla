...
$langvars = array (
	...
	'PHPSHOP_PRODUCT_FORM_DELETE_PRODUCT_MSG' => 'ต้องการลบสินค้า และรายละเอียดที่เกี่ยวข้องกับสินค้านี้?',
	...
	'PHPSHOP_PRODUCT_FORM_PACKAGING_DESCRIPTION' => 'คุณสามารถใส่จำนวนของตัวเลขภายในแพคเกจ. (เต็มที่ใส่ได้. 65535)',
	'PHPSHOP_PRODUCT_FORM_BOX' => 'หน่วยในกล่อง',
	'PHPSHOP_PRODUCT_FORM_BOX_DESCRIPTION' => 'คุณสามารถใส่จำนวนของตัวเลขภายในกล่อง. (เต็มที่ใส่ได้. 65535)',
	...
	'VM_PRODUCT_PRODUCT_TYPE_ADD_MULTIPLE_PRODUCTS' => ' สินค้าหลายรายการ',
	...
	'PHPSHOP_PRODUCT_TYPE_PARAMETER_FORM_NAME_DESCRIPTION' => 'ชื่อนี้จะเป็นชื่อคอลัมน์ของตาราง. จะต้องเป็นภาษาอังกฤษตัวเล็ก และไม่มีช่องว่าง.<br/>ตัวอย่างเช่น: main_material',
	'PHPSHOP_PRODUCT_TYPE_PARAMETER_FORM_LABEL' => 'พารามิเตอร์ป้าย',
	'PHPSHOP_PRODUCT_TYPE_PARAMETER_FORM_TYPE_INTEGER' => 'ตัวเลข',
	'PHPSHOP_PRODUCT_TYPE_PARAMETER_FORM_TYPE_TEXT' => 'อักษร',
	'PHPSHOP_PRODUCT_TYPE_PARAMETER_FORM_TYPE_SHORTTEXT' => 'ตัวย่อ',
	'PHPSHOP_PRODUCT_TYPE_PARAMETER_FORM_TYPE_FLOAT' => 'ทศนิยม',
	'PHPSHOP_PRODUCT_TYPE_PARAMETER_FORM_TYPE_CHAR' => 'ตัวอักษร',
	'PHPSHOP_PRODUCT_TYPE_PARAMETER_FORM_TYPE_DATETIME' => 'วันและเวลา',
	'PHPSHOP_PRODUCT_TYPE_PARAMETER_FORM_TYPE_DATE' => 'วัน',
	'PHPSHOP_PRODUCT_TYPE_PARAMETER_FORM_TYPE_TIME' => 'เวลา',
	'PHPSHOP_PRODUCT_TYPE_PARAMETER_FORM_TYPE_BREAK' => 'Break Line',
	'PHPSHOP_PRODUCT_TYPE_PARAMETER_FORM_TYPE_MULTIVALUE' => 'ค่าหลากหลาย',
	'PHPSHOP_PRODUCT_TYPE_PARAMETER_FORM_VALUES' => 'ค่าที่เป็นไปได้',
	'PHPSHOP_PRODUCT_TYPE_PARAMETER_FORM_MULTISELECT' => 'แสดงค่าที่เป็นไปได้ เป็นการเลือกหลากหลาย?',
	...
	'PHPSHOP_PRODUCT_TYPE_PARAMETER_FORM_DEFAULT' => 'ค่าปกติ',
	...
	'PHPSHOP_PRODUCT_TYPE_PARAMETER_FORM_UNIT' => 'หน่วย',
	'PHPSHOP_PRODUCT_CLONE' => 'เลียนแบบสินค้า',
	'PHPSHOP_HIDE_OUT_OF_STOCK' => 'ซ่อนสินค้าที่อยู่นอกสต๊อก',
	'PHPSHOP_FEATURED_PRODUCTS_LIST_LBL' => 'คุณลักษณะ และส่วนลด สินค้า',
	'PHPSHOP_FEATURED' => 'คุณลักษณะ',
	'PHPSHOP_SHOW_FEATURED_AND_DISCOUNTED' => 'คุณลักษณะ และส่วนลด',
	'PHPSHOP_SHOW_DISCOUNTED' => 'สินค้าลดราคา',
	'PHPSHOP_FILTER' => 'ค้นหา',
	'PHPSHOP_PRODUCT_FORM_DISCOUNTED_PRICE' => 'ลดราคา',
...
The Shop will create a new discount record from the discounted price.',
	'PHPSHOP_PRODUCT_LIST_QUANTITY_START' => 'จำนวนเริ่มต้น',
	'PHPSHOP_PRODUCT_LIST_QUANTITY_END' => 'จำนวนสุดท้าย',
	'VM_PRODUCTS_MOVE_LBL' => 'ย้ายสินค้าจากแคตตาล๊อกไปยังที่อื่น',
	'VM_PRODUCTS_MOVE_LIST' => 'คุณได้เลือกที่จะย้ายสินค้าตามนี้ %s',
	'VM_PRODUCTS_MOVE_TO_CATEGORY' => 'ย้ายไปยังแคตตาล๊อก..',
	'VM_PRODUCT_LIST_REORDER_TIP' => 'เลือกแคตตาล๊อกสินค้า เพื่อสั่งสินค้าใหม่ในหมวดหมู่',
	'VM_REVIEW_FORM_LBL' => 'เพิ่มสินค้าแนะนำ',
	'PHPSHOP_REVIEW_EDIT' => 'เพิ่ม/แก้ไข สินค้าแนะนำ',
	'SEL_CATEGORY' => 'เลือก แคตตาล๊อก',
	'VM_PRODUCT_FORM_MIN_ORDER' => 'จำนวนสั่งซื้อน้อยที่สุด',
	'VM_PRODUCT_FORM_MAX_ORDER' => 'จำนวนสั่งซื้อมากที่สุด',
	'VM_DISPLAY_TABLE_HEADER' => 'แสดงหัวตาราง',
	'VM_DISPLAY_LINK_TO_CHILD' => 'ลิงค์ไปยังสินค้าที่เกี่ยวข้องจากลิส',
	'VM_DISPLAY_INCLUDE_PRODUCT_TYPE' => 'รวมชนิดสินค้าย่อย',
	'VM_DISPLAY_USE_LIST_BOX' => 'ใช้กล่องรายการสำหรับสินค้าย่อย',
	'VM_DISPLAY_LIST_STYLE' => 'รูปแบบรายการ',
	'VM_DISPLAY_USE_PARENT_LABEL' => 'ใช้การตั้งค่าของรายการหลัก:',
	'VM_DISPLAY_LIST_TYPE' => 'รายการ:',
	'VM_DISPLAY_QUANTITY_LABEL' => 'จำนวน:',
	'VM_DISPLAY_QUANTITY_DROPDOWN_LABEL' => 'จำนวนใน Drop Down Box',
	'VM_DISPLAY_CHILD_DESCRIPTION' => 'แสดงคำอธิบายสินค้าย่อย',
	'VM_DISPLAY_DESC_WIDTH' => 'จำนวนคำอธิบายของผลิตภัณฑ์ย่อย',
	...
	'PHPSHOP_DISPLAY_RADIOBOX' => 'ใช้ Radio Box',
	'PHPSHOP_PRODUCT_FORM_ITEM_DISPLAY_LBL' => 'ออพชั่นการแสดงผล',
	...
	'PHPSHOP_DISPLAY_DROPDOWN' => 'ใช้ Dropdown Box',
	'PHPSHOP_DISPLAY_CHECKBOX' => 'ใช้ Check Box',
	'PHPSHOP_DISPLAY_ONE' => 'ปุ่มหยิบใส่ตะกร้าปุ่มเดียว',
	'PHPSHOP_DISPLAY_MANY' => 'ปุ่มหยิบใส่ตะกร้า สำหรับรายการลูก',
	'PHPSHOP_DISPLAY_START' => 'ค่าเริ่มต้น',
	'PHPSHOP_DISPLAY_END' => 'ค่าสิ้นสุด',
	'PHPSHOP_DISPLAY_STEP' => 'ค่าถัดไป',
	'PRODUCT_WAITING_LIST_TAB' => 'รายการที่รออยู่',
	'PRODUCT_WAITING_LIST_USERLIST' => 'ผู้ใช้รอการแจ้งผล เมื่อสินค้านี้ ถูกส่งกลับเข้าไปในคลัง',
	'PRODUCT_WAITING_LIST_NOTIFYUSERS' => 'แจ้งผู้ใช้ตอนนี้ (เมื่อ คุณได้ปรับปรุงคลังสินค้าจำนวนหนึ่ง)',
	'PRODUCT_WAITING_LIST_NOTIFIED' => 'แจ้ง',
	'VM_PRODUCT_FORM_AVAILABILITY_SELECT_IMAGE' => 'เลือกรูปภาพ',
	'VM_PRODUCT_RELATED_SEARCH' => 'ค้นหาสินค้า หรือประเภทที่นี่:',
	'VM_FILES_LIST_ROLE' => 'Role',
	'VM_FILES_LIST_UP' => 'Up',
	'VM_FILES_LIST_GO_UP' => 'Go Up',
	'VM_CATEGORY_FORM_PRODUCTS_PER_ROW' => 'แสดง x สินค้าต่อแถว',
	'VM_CATEGORY_FORM_BROWSE_PAGE' => 'หน้าแสดงประเภท',
	'VM_PRODUCT_CLONE_OPTIONS_TAB' => 'ออพชั่นผลิตภัณฑ์เลียนแบบ',
	'VM_PRODUCT_CLONE_OPTIONS_LBL' => 'เลียนแบบรายการลูกเหล่านี้',
	'VM_PRODUCT_LIST_MEDIA' => 'Media',
	'VM_REVIEW_LIST_NAMEDATE' => 'ชื่อ/วัน',
	'VM_PRODUCT_SELECT_ONE_OR_MORE' => 'เลือกสินค้า 1 ตัวหรือหลายตัว',
	'VM_PRODUCT_SEARCHING' => 'ค้นหา...',
	'PHPSHOP_PRODUCT_FORM_ATTRIBUTE_LIST_EXAMPLES' => '<h4>ตัวอย่างสำหรับรูปแบบรายการ:</h4>
...
Price = +10 to add this amount to the configured price.<br />  Price = -10 to subtract this amount from the configured price.<br />  Price = 10 to set the product\'s price to this amount.',
	'VM_FILES_FORM_PRODUCT_IMAGE' => 'รูปภาพสินค้า (ขนาดใหญ่ และย่อ)',
	'VM_FILES_FORM_DOWNLOADABLE' => 'การดาวน์โหลดไฟล์สินค้า (to be sold!)',
	'VM_FILES_FORM_RESIZE_IMAGE' => 'เปลี่ยนขนาดไฟล์รูปภาพขนาดใหญ่?'
